...
const panels: Record<
  string,
  { description: string; signals?: { text: string; detail: string }[] }
> = {
  "/signup": {
    description:
    ...
    signals: [
      { text: "Free to join", detail: "Create your profile at no cost" },
      {
        ...
        detail: "Set your rates, availability, and service area",
      },
      {
        text: "Verified by our team",
        detail: "A verified badge builds trust with families",
      },
    ],
  },
  "/signup/confirm": {
    description:
      "You are almost there. Check your inbox for a confirmation link to activate your account.",
  },
  "/login": {
    description:
    ...
    signals: [
      ...
      },
      {
        ...
        detail: "We never share your information without consent",
      },
      {
  ...
  "/forgot-password": {
    description:
      "No worries. We will send you a link to reset your password and get you back in.",
  },
  "/forgot-password/sent": {
    description:
      "A reset link is on its way. Check your inbox and follow the link to set a new password.",
  },
  "/reset-password": {
    description:
      "Almost there. Set a new password and you will be back to your account in no time.",
  },
  "/role-select": {
    description:
      "One quick step so we can tailor NurseDex to how you will use it.",
  },
};
        ...
        <div className="space-y-4">
          {panel.signals.map((item) => (
            <div key={item.text} className="flex items-start gap-3">
              <Check
                className="text-cream mt-0.5 h-4 w-4 shrink-0"
                strokeWidth={2.5}
              />
