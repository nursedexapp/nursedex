      ...
      <article className="mx-auto max-w-2xl">
        ...
        <div className="font-body text-soft-black-light mt-10 space-y-8 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              NurseDex is a directory platform that connects Long Island
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              discrimination, or personal attacks. NurseDex reserves the right
              to moderate, edit, or remove reviews that violate these standards.
            </p>
            <p className="mt-3">
