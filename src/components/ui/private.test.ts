...
describe("the revealed contact card is BLOCKED, not merely masked", () => {
  // One card, two callers (#831): the profile page server-renders it and
  // ContactReveal renders it in the browser the moment a reveal succeeds. The
  // guard lives on the shared card so both paths are covered by one class.
