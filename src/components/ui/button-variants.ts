...
// Kept in its own module (not "use client") so it can be called during
// server render. button.tsx is a client component, so importing
// buttonVariants from it taints the binding as a client reference and
// calling it from a server component throws.
